...
2. El contrato front↔back está en `contracts/openapi.yaml`.
3. Los specs (el QUÉ) están en `docs/specs/`.
4. Las decisiones de arquitectura están en `docs/adr/`.
5. Los skills del proyecto (recetas reutilizables) viven en `.opencode/skills/` — opencode los carga automáticamente.
...
- Leer/crear/actualizar HUs vía REST API: consulta `docs/plane-api.md`.
